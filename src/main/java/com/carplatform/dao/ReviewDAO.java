...
public class ReviewDAO {
    ...
    private static final String FILE_PATH = "c:/Users/aruno/Desktop/untitled/src/main/webapp/WEB-INF/data/reviews.txt";
    ...
    public List<Review> getAllReviews() {
        ...
        for (String line : lines) {
            ...
            if (parts.length < 8) continue;
            {
                ...
                Review r = new Review(reviewId, buyerId, carId, sellerId, rating, comment, reviewType, createdAt);
                reviews.add(r);
            }
        }
        return reviews;

...
public class TransactionDAO {
    ...
    private static final String FILE_PATH = "c:/Users/aruno/Desktop/untitled/src/main/webapp/WEB-INF/data/transactions.txt";
    ...
    public void saveTransaction(Transaction t) {
        if (t == null) return;
        FileHandler.writeLine(FILE_PATH, t.toFileString());
    }

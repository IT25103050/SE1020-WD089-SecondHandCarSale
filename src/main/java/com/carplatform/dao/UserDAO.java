...
public class UserDAO {
    ...
    public UserDAO(ServletContext servletContext) {
        ...
        if (path == null) {
            System.err.println("[UserDAO] WARNING: ServletContext.getRealPath returned null. Falling back to relative path.");
    ...
    public void saveUser(User user) {
        if (user == null) return;
        FileHandler.writeLine(filePath, user.toFileString());
    }
    ...
    private User createUserInstance(String role) {
        ...
        // Default to Seller for this module
        return new Seller();
    }

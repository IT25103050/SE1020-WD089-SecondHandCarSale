...
public class CarController {
    ...
    private static final String FILE_PATH = "WEB-INF/data/cars.txt";

    public CarController(CarDAO carDAO, UserDAO userDAO, ReviewDAO reviewDAO) {
        this.carDAO = carDAO;
    ...
    public String showCarDetails(@RequestParam("carId") String carId, Model model) {
        ...
        List<Review> reviews = reviewDAO.getReviewsByCarId(carId);

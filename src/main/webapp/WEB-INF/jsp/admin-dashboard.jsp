            ...
            <div class="row g-4">
                ...
                <div class="col-lg-10 col-md-9">
                    ...
                    <div class="card border-0 rounded-4 shadow-sm bg-white p-4 mb-4 border-start border-secondary border-5">
                        <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3">
                            ...
                            <div class="d-flex gap-2">
                                <a href="${pageContext.request.contextPath}/pending-cars" class="btn btn-outline-secondary fw-semibold rounded-3 fs-7">
                                    <i class="bi bi-car-front me-1"></i> Pending Vehicles
                                </a>
                    ...
                    <div class="row g-3 mb-4">
                        ...
                        <div class="col-sm-6 col-lg-4">
                            <div class="p-3 bg-white rounded-4 border shadow-sm d-flex align-items-center gap-3">
                                ...
                                <div>
                                    <span class="text-slate-400 fs-8 text-uppercase tracking-wider d-block fw-bold">Total Vehicles</span>
                                    <h3 class="fw-bolder text-secondary mb-0">${stats.totalCars}</h3>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 col-lg-4">
                            <div class="p-3 bg-white rounded-4 border shadow-sm d-flex align-items-center gap-3">
                                ...
                                <div>
                                    <span class="text-slate-400 fs-8 text-uppercase tracking-wider d-block fw-bold">Pending Vehicles</span>
                                    <h3 class="fw-bolder text-secondary mb-0">${stats.pendingCarsCount}</h3>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 col-lg-4">
                            <div class="p-3 bg-white rounded-4 border shadow-sm d-flex align-items-center gap-3">
                                <div class="bg-dark bg-opacity-10 text-dark rounded-circle p-3 d-flex align-items-center justify-content-center" style="width: 55px; height: 55px;">
                                    <i class="bi bi-star-fill fs-4"></i>
                                </div>
                                <div>
                                    <span class="text-slate-400 fs-8 text-uppercase tracking-wider d-block fw-bold">Total Reviews</span>
                                    <h3 class="fw-bolder text-secondary mb-0">${stats.totalReviews}</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row g-4">
                        ...
                        <!-- Left Pending Cars Roster Column -->
                        <div class="col-lg-6">
                            <div class="card border-0 rounded-4 shadow-sm bg-white p-4 h-100">
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    <div>
                                        <span class="text-warning fw-bold fs-8 text-uppercase tracking-widest d-block">Action Needed</span>
                                        <h5 class="fw-bold text-secondary mb-0">Pending Vehicles</h5>
                                    </div>
                                    <a href="${pageContext.request.contextPath}/pending-cars" class="btn btn-outline-secondary btn-sm fw-semibold rounded-pill px-3">
                                        View All
                                    </a>
                                </div>
                                ...
                                <c:choose>
                                    <c:when test="${empty pendingCars}">
                                        <div class="p-4 bg-light rounded-4 text-center my-auto border">
                                            <i class="bi bi-check2-all text-success fs-2 d-block mb-1"></i>
                                            <span class="fw-semibold text-slate-500 fs-7">There are no vehicles pending approval.</span>
                                        </div>
                                    </c:when>
                                    <c:otherwise>
                                        <div class="d-flex flex-column gap-2">
                                            <c:forEach var="car" items="${pendingCars}" end="3">
                                                <div class="p-3 bg-light rounded-3 border d-flex justify-content-between align-items-center">
                                                    <div>
                                                        <span class="badge bg-white text-secondary border px-2 py-0 fs-8 me-1">${car.fuelType}</span>
                                                        <strong class="text-secondary fs-7">${car.brand} ${car.model}</strong>
                                                        <span class="text-slate-400 fs-8 d-block mt-1">Vehicle ID: <code>${car.carId}</code> &bull; Price: LKR <fmt:formatNumber value="${car.price}" pattern="#,###" /></span>
                                                    </div>
                                                    <form action="${pageContext.request.contextPath}/approve-car" method="post" class="d-flex gap-1">
                                                        <input type="hidden" name="carId" value="${car.carId}">
                                                        <input type="hidden" name="approvalStatus" value="APPROVED">
                                                        <button type="submit" class="btn btn-success btn-sm px-2 py-1 fs-8" title="Approve">

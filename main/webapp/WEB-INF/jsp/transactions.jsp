...
<c:set var="pageTitle" value="My Transactions | AutoMart" scope="request" />
<!DOCTYPE html>
                ...
                <div class="col-lg-10 col-md-9">
                    ...
                    <div class="card border-0 rounded-4 shadow-sm bg-white p-4">
                        ...
                        <div class="border-bottom pb-3 mb-4 d-flex justify-content-between align-items-center">
                            <div>
                                <span class="badge bg-danger px-3 py-1 rounded-pill text-uppercase tracking-widest fs-8 mb-1">Purchase History</span>
                                <h3 class="fw-bolder text-secondary mb-0">My Transactions</h3>
                                <p class="text-slate-400 fs-7 mb-0 mt-1">
                                    View your past and pending purchases and sales.
                                </p>
                            </div>
                        ...
                        <c:if test="${not empty param.cancelled}">
                            <div class="alert alert-danger alert-auto-dismiss rounded-3 fs-7 py-2 px-3 mb-4 shadow-sm" role="alert">
                                <i class="bi bi-x-circle-fill me-2 text-danger"></i> Transaction cancelled successfully.
                            </div>
                        </c:if>
                        ...
                        <c:choose>
                            <c:when test="${empty transactions}">
                                <div class="p-5 text-center bg-light rounded-4 border my-4">
                                    <i class="bi bi-receipt text-slate-300 fs-1 d-block mb-2"></i>
                                    ...
                                    <p class="text-slate-400 fs-7 max-w-md mx-auto mb-0">
                                        You don't have any purchase or sale history yet.
                                    </p>
                                </div>
                            </c:when>
                            <c:otherwise>
